...
public class ATCSNightmare {
	...
	public static void main(String[] args) {
		...
		String f = in.next();
		// System.out.println(linkDemLists("Hellotherehowareyou123456789"));
		// System.out.println(recurses("Hellotherehowareyou123456789","",1));
		if (f.length() == 34 && f.substring(0, 4).equals("flag") && f.charAt(33) == '}') {
			...
			System.out.println("Sorry, that is incorrect.len");
		in.close();
	}
}
